...
export const Header = (props)=>{
    return(
        <div className=" header d-flex flex-row justify-content-between header">
            <div className="logo">
                <a href="/">
               ...
               <button className="search-btn"><i className="fa-solid fa-magnifying-glass" style={{color: "#000000", fontSize:"30px"}}></i></button>
            </div>
            <div className="nav d-flex flex-row justify-content-around align-items-center">
                ...
                <li className="m-1">
                    ...
                    <i className="fa-solid fa-cart-shopping" style={{color: "#000000 ", fontSize:"30px"}}></i>
                    </button>
                </li>
                <li className="m-1">
                    <button className="btn profile">
                    <i className="fa-solid fa-user" style={{color: "#000000", fontSize:"30px"}}></i>
                    </button>
                </li>
            </div>
        </div>
